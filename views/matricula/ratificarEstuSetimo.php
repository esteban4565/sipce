        ...
        <fieldset>
            ...
            <div class="form-group"> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-2">
                        <input type="text" class="form-control input-sm validate[custom[number]]"  id="tf_edad" name="tf_edad" value='<?php if ($this->anio != null) echo $this->anio - (date(substr($this->infoEstuPrematricula[0]['fechaNacimiento'], 0, 4))); ?>' onkeyup="mayusculas(this)"/>
                    </div>
