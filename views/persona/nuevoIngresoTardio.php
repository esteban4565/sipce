...
?>
<div class="row">
    <form id="MyForm" action="<?php echo URL; ?>persona/guardarNuevoIngresoTardio" method="POST" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
            ...
            <div class="form-group"> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-2">
                        <select class="form-control input-sm validate[required]" name="tf_provincias_NI" id="tf_provincias">
                            <option value="">Seleccione</option>
                            <?php
                    ...
                    <div class="col-xs-2">
                        <select class="form-control input-sm validate[required]" name="tf_cantones_NI" id="tf_cantones">
                            
                        </select>
                    </div>
                    <label for="tf_distritos_NI" class="col-xs-2 control-label">Distrito:</label>
                    <div class="col-xs-2">
                        <select  class="form-control input-sm validate[required]" name="tf_distritos_NI" id="tf_distritos">  
