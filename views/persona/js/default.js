...
//**Cosas de Esteban**//
    ...
    $("#tf_Niveles").change(function () {
        ...
        var consulta = {nivelSeleccionado: $("#tf_Niveles").val(), grupoSeleccionado: 0, chk_email: chk_email,
            ...
            chk_telefonosEncargado: chk_telefonosEncargado, chk_fechaNacimiento: chk_fechaNacimiento,
            chk_genero: chk_genero, chk_condicion: chk_condicion};
        ...
        $.post('../persona/cargaSeccion/', consulta, function (seccionElegida, success) {
            ...
            for (var linea = 0; linea < seccionElegida.length; linea++) {
                ...
                if (chk_condicion == 1) {
                    if (seccionElegida[linea].condicion != null) {
                        arraySalida += '<td>' + seccionElegida[linea].condicion + '</td>';
                    } else {
                        arraySalida += '<td> - </td>';
                    }
                }
