<div class="row">
    <div class="col-xs-3">
        <a class="btn btn-success" href="<?php echo URL; ?>persona/listaBecas">Vel lista completa</a>
    </div>
    <div class="col-xs-3">
    ...
    <div class="col-xs-12">
        <table class="table table-condensed" id="listaBecados">
            <tr>
                <td colspan="16" class="nombreTabla text-center">RUTA ALAJUELA</td>
            </tr>
            <tr>
                <th>N°</th>
            ...
            foreach ($this->listaEstudianteBecas as $lista => $value) {
                if (isset($value['numeroRuta']) && isset($value['nivel'])) {
                    if ($value['numeroRuta'] == '5931' && $value['nivel'] >= 10) {
                        echo '<tr>';
                        echo '<td>';
                        echo $con;
                        echo '</td>';
