<div class="row">
    <div class="col-xs-12">
        ...
        <div class="form-group">
            <label for="sl_Nivel" class="col-xs-1 control-label text-right">Nivel:</label>
            <div class="col-xs-2 text-left">
                <select class="form-control input-sm" name="sl_NivelListaEstudiante" id="sl_NivelListaEstudiante">
            ...
            <div class="col-xs-3 text-left">
                <select class="form-control input-sm" name="sl_EspecialidadlListaEstudiante" id="sl_EspecialidadlListaEstudiante">
                    <option value="">Seleccione</option>
