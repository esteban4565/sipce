...
//            echo '<br> Cantidad de Mujeres: ' . $contadorMujeres . '<br>';
//            print_r($arraylistaEstudiantesMujeres);
//            echo '<br> Cantidad de Hombres: ' . $contadorHombres . '<br>';
//            print_r($arraylistaEstudiantesHombres);
